...
class StatsSeeder extends Seeder
{
    public function run(): void
    {
        ...
        $stats = [
            ...
            ['value' => '3', 'label' => 'Core Pillars of Focus', 'icon_name' => 'bi-columns', 'sort_order' => 3, 'is_active' => true],
            ['value' => '5', 'label' => 'Program Areas', 'icon_name' => 'bi-grid-fill', 'sort_order' => 4, 'is_active' => true],
        ];
