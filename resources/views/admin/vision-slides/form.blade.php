...
<div class="stat-card" style="max-width:700px;">
    <form method="POST" action="{{ route('admin.vision-slides.update', $slide) }}">
        ...
        <div class="row g-3 mb-3">
            ...
            <div class="col-md-4">
                <label class="form-label">Tag <span style="font-weight:400;color:var(--mg-text-subtle);text-transform:none;letter-spacing:0;">(badge above title)</span></label>
        ...
        <div class="row g-3 mb-3">
            <div class="col-md-5">
                <label class="form-label">Pill Label <span style="font-weight:400;color:var(--mg-text-subtle);text-transform:none;letter-spacing:0;">(button text)</span></label>
...
(function () {
    ...
    function update() {
        ...
        iconEl.className = 'bi ' + (ic || 'bi-star-fill');
